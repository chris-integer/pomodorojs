...
window.addEventListener('load', () => {
    ...
    soundAlarm = new Audio('sound/alarm.wav');
})
...
function eraseHora() {
    document.getElementById('horita').value = '';
}

function eraseMinutos() {
    document.getElementById('minutitos').value = '';
}

function eraseSegundos() {
    document.getElementById('segunditos').value = '';
}